...
AgentForge is built on three principles:
...
For Playwright-specific testing, AgentForge installs Chromium automatically on first run in dev mode. In packaged builds, Chromium must be bundled — see `build-mac.sh`.
