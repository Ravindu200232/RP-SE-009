    ...
    <div className="w-full bg-white text-slate-800">
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-9">
              <Link href="/register" className="bg-ACCENT-600 hover:bg-ACCENT-700 text-white rounded-xl px-7 py-3.5 font-semibold shadow-lg shadow-ACCENT-600/25 transition">Get Started Free</Link>
              <Link href="/login" className="border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 rounded-xl px-7 py-3.5 font-semibold transition">Sign in</Link>
            </div>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <img src="/assets/feature1.jpg" alt="" onError={hide} className="rounded-3xl h-64 w-full object-cover shadow-md" />
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            {tiers.map((t) => (
              <div key={t.name} className={'rounded-2xl border p-7 bg-white ' + (t.popular ? 'border-ACCENT-300 ring-2 ring-ACCENT-500 shadow-xl relative' : 'border-slate-200 shadow-sm')}>
                ...
                <Link href="/register" className={'block text-center rounded-xl px-5 py-3 font-semibold transition ' + (t.popular ? 'bg-ACCENT-600 hover:bg-ACCENT-700 text-white' : 'border border-slate-200 hover:bg-slate-50 text-slate-700')}>Choose {t.name}</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="border-t border-slate-200 py-14 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
          ...
          <div><p className="font-semibold mb-3 text-sm text-slate-900">Product</p><div className="space-y-2 text-sm text-slate-500"><Link href="/features" className="block hover:text-slate-800">Features</Link><Link href="/about" className="block hover:text-slate-800">About</Link><Link href="/contact" className="block hover:text-slate-800">Contact</Link></div></div>
          <div><p className="font-semibold mb-3 text-sm text-slate-900">Account</p><div className="space-y-2 text-sm text-slate-500"><Link href="/login" className="block hover:text-slate-800">Sign in</Link><Link href="/register" className="block hover:text-slate-800">Get started</Link></div></div>
