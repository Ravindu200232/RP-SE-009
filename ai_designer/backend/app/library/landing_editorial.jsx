    ...
    <div className="w-full bg-stone-50 text-stone-800">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-10 items-end">
          ...
          <div className="lg:col-span-5 lg:pb-3">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link to="/register" className="bg-stone-900 hover:bg-stone-800 text-white rounded-full px-7 py-3.5 font-semibold transition">Get Started</Link>
              <Link to="/login" className="inline-flex items-center gap-2 font-semibold text-stone-700 hover:text-ACCENT-600 transition">Sign in <Icon name="arrow-right" className="w-4 h-4" /></Link>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-stone-950/80 via-stone-950/20 to-transparent flex items-end">
            <div className="p-10 flex items-end justify-between w-full flex-wrap gap-6">
              ...
              <Link to="/register" className="bg-white text-stone-900 hover:bg-stone-100 rounded-full px-7 py-3.5 font-semibold transition">Book / Start now</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <img src="assets/about.jpg" alt="" onError={hide} className="rounded-3xl h-96 w-full object-cover shadow-lg" />
          <div>
            ...
            <Link to="/about" className="inline-flex items-center gap-2 font-semibold text-ACCENT-700 hover:text-ACCENT-800">More about us <Icon name="arrow-right" className="w-4 h-4" /></Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            {tiers.map((t) => (
              <div key={t.name} className={'rounded-3xl p-8 ' + (t.popular ? 'bg-stone-900 text-white shadow-2xl relative' : 'bg-white border border-stone-200 shadow-sm')}>
                ...
                <Link to="/register" className={'block text-center rounded-full px-5 py-3 font-semibold transition ' + (t.popular ? 'bg-ACCENT-500 hover:bg-ACCENT-400 text-white' : 'bg-stone-900 hover:bg-stone-800 text-white')}>Choose {t.name}</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-5xl mx-auto text-center rounded-3xl bg-ACCENT-600 p-12">
          ...
          <Link to="/register" className="inline-block bg-white text-stone-900 hover:bg-stone-100 rounded-full px-8 py-3.5 font-semibold shadow-xl transition">Get Started</Link>
        </div>
      </section>
      <footer className="border-t border-stone-200 py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-sm text-stone-500">
            <Link to="/features" className="hover:text-stone-800">Features</Link>
            <Link to="/about" className="hover:text-stone-800">About</Link>
            <Link to="/contact" className="hover:text-stone-800">Contact</Link>
            <Link to="/login" className="hover:text-stone-800">Sign in</Link>
          </div>
