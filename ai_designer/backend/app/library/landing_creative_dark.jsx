    ...
    <div className="w-full bg-slate-950 text-slate-100 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link to="/register" className="bg-ACCENT-600 hover:bg-ACCENT-500 text-white rounded-xl px-7 py-3.5 font-semibold shadow-lg shadow-ACCENT-600/30 transition">Get Started Free</Link>
              <Link to="/login" className="inline-flex items-center gap-2 text-slate-300 hover:text-white font-medium px-4 py-3.5 transition">Sign in <Icon name="arrow-right" className="w-4 h-4" /></Link>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            {tiers.map((t) => (
              <div key={t.name} className={'rounded-2xl border p-7 ' + (t.popular ? 'border-ACCENT-400/50 bg-ACCENT-500/[0.07] ring-1 ring-ACCENT-400/40 relative' : 'border-white/10 bg-white/[0.03]')}>
                ...
                <Link to="/register" className={'block text-center rounded-xl px-5 py-3 font-semibold transition ' + (t.popular ? 'bg-ACCENT-600 hover:bg-ACCENT-500 text-white' : 'border border-white/15 hover:bg-white/5 text-slate-200')}>Choose {t.name}</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-4 pb-24">
        <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-ACCENT-700 to-ACCENT-500 p-12 text-center relative overflow-hidden">
          ...
          <Link to="/register" className="inline-block bg-white text-slate-900 hover:bg-slate-100 rounded-xl px-8 py-3.5 font-semibold shadow-xl transition">Start now - it's free</Link>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 py-14 px-4">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
          ...
          <div><p className="font-semibold mb-3 text-sm">Product</p><div className="space-y-2 text-sm text-slate-500"><Link to="/features" className="block hover:text-slate-300">Features</Link><Link to="/about" className="block hover:text-slate-300">About</Link><Link to="/contact" className="block hover:text-slate-300">Contact</Link></div></div>
          <div><p className="font-semibold mb-3 text-sm">Account</p><div className="space-y-2 text-sm text-slate-500"><Link to="/login" className="block hover:text-slate-300">Sign in</Link><Link to="/register" className="block hover:text-slate-300">Get started</Link></div></div>
