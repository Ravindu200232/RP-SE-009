...
PARADIGMS = {
    ...
    "glassmorphism": {
        ...
        "texture": (
            ...
            ".paradigm-glass [class*='rounded-xl'],.paradigm-glass [class*='rounded-2xl'],.paradigm-glass [class*='rounded-3xl']{"
    ...
    "cyberpunk": {
        ...
        "texture": (
            ...
            ".paradigm-cyber [class*='rounded-xl'],.paradigm-cyber [class*='rounded-2xl'],.paradigm-cyber [class*='rounded-3xl']{"
