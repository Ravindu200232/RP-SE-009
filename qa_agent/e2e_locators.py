...
class E2ELocatorsMixin:
    ...
    def _field_hint(sel) -> str:
        ...
        for key, words in (
            ...
            ("price", ("price", "pricing", "rate", "nightly", "cost")),
            ...
            ("end", ("end", "checkout", "check-out", "until", "to")),
            ("search", ("search", "find")),
    ...
    def _route_from_page(self, page, *, include_query: bool = False) -> str:
        ...
        different: query parameters are often business state (``bookingId``,
        ``roomId``, filters, invite tokens).  Losing them turns a trustworthy
