...
def capability_contract(arch, journey: dict) -> dict:
    ...
    return {
        ...
        "actor": _actor_class(role),
        "requires_session": _actor_class(role) != "public",
...
def scenario_contract_issue(contract: dict, scenario, is_business_step) -> str:
    ...
    first = business[0]
    proof_verbs = {"EXPECT_TEXT", "EXPECT_URL", "EXPECT_VALUE", "EXPECT_MUTATION",
                   "WAIT_FOR", "EXPECT_NO_ERROR"}
