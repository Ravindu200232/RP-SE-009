...
class E2ELoopGuardMixin:
    ...
    This is deliberately not a route-count or complexity gate. It observes only
    the local app's known page URLs, ignores Next prefetch traffic, and aborts
    only a same-page burst that cannot be normal human navigation. The fault is
    kept as debugger evidence so the generated app is repaired instead of the
    symptom merely being rate-limited.
    """
