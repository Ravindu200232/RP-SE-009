"""Vitest config/setup and deterministic MongoDB mock materialization."""
from qa_agent.unit.harness_common import *
                    ...
                    switch (op) {
                      ...
                      default:
                        throw new Error(
                          ...
                          'add it in qa_agent/unit/harness.py or assert a different way.')
                    }
                  })
                }
                return same(got, cond)
                ...
                switch (op) {
                  ...
                  default:
                    throw new Error(
                      ...
                      'it in qa_agent/unit/harness.py or assert a different way.')
                }
              }
              return doc
            }
