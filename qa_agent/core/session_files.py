...
from qa_agent.core.session_common import *
...
from qa_agent.core.session_queue import QASessionQueueMixin


class QASession(QASessionQueueMixin, QASessionFilesMixin, QASessionBase):
    """Concrete QA session coordinating source snapshots and test queues."""
    pass
