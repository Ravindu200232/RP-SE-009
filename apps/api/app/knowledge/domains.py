...
# Universal tables every system gets (auth / RBAC / audit).
...
# Generic fallback used when no domain is confidently matched.
...
def classify_domain(text: str) -> tuple[str, float, str]:
    ...
    # Confidence blends share-of-hits with absolute evidence.
