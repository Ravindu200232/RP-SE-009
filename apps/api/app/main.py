...
from .routers import analyze, customize, downloads, events, projects, srs
...
for r in (projects.router, analyze.router, srs.router, customize.router,
          downloads.router, events.router):
