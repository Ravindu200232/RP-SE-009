export const CURATED = [
  { id: 'llama3.1:8b', label: 'Llama 3.1 8B', icon: '🦙', tag: 'fast',
    desc: 'Meta. Fast instruction following.' },
  { id: 'llama3.2:3b', label: 'Llama 3.2 3B', icon: '🦙', tag: 'fast',
    desc: 'Meta. Ultra-fast, lightweight.' },
  { id: 'mistral:7b', label: 'Mistral 7B', icon: '⚡', tag: 'fast',
    desc: 'Mistral AI. Quick, solid reasoning.' },
  { id: 'phi4:14b', label: 'Phi-4 14B', icon: '🔬', tag: 'quality',
    desc: 'Microsoft. Excellent reasoning for its size.' },
  { id: 'gemma3:12b', label: 'Gemma 3 12B', icon: '💎', tag: 'quality',
    desc: 'Google. Strong general model.' },
  { id: 'qwen2.5-coder:14b', label: 'Qwen 2.5 Coder 14B', icon: '⚛', tag: 'code',
    desc: 'Best local model for code.' },
  { id: 'qwen2.5-coder:7b', label: 'Qwen 2.5 Coder 7B', icon: '⚛', tag: 'code',
    desc: 'Lighter code model.' },
  { id: 'deepseek-coder-v2:16b', label: 'DeepSeek Coder V2 16B', icon: '🔍', tag: 'code',
    desc: 'Excellent at code generation.' },
  { id: 'codellama:13b', label: 'Code Llama 13B', icon: '🦙', tag: 'code',
    desc: 'Meta. Llama fine-tuned for code.' },
  { id: 'llama3.1:70b', label: 'Llama 3.1 70B', icon: '🦙', tag: 'big',
    desc: 'Highest quality — needs a lot of memory.' },
  { id: 'qwen2.5:72b', label: 'Qwen 2.5 72B', icon: '⚛', tag: 'big',
...
export function catalogue(payload) {
  ...
  const byId = new Map()
  for (const m of localObjs) byId.set(m.id, { icon: '💻', tag: 'local', ...m })
  for (const id of installed) {
    if (!byId.has(id)) byId.set(id, { id, icon: '💻', tag: 'local' })
  }
