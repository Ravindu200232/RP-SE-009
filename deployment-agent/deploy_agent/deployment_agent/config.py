...
def app_data_dir() -> Path:
    ...
    Under AgentForge this is production-ready/.deploy/ rather than
    %LOCALAPPDATA%\\DeploymentAgent — see `deploy_agent.bridge.DEPLOY_DATA`.
    The import is inside the function and guarded because this module is
    imported by the copy's own tests, which run without AgentForge around them.
    """
