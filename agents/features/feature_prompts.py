...
PROMPT_FILE = Path(__file__).with_name("feature_prompt.txt")


# Loads one named contract; keep a safe fallback for packaged installs.
...
# Returns the extra feature contract only when visual generation was asked for.
