...
# Checks whether noise is true for the current pipeline state.
def _is_noise(line: str) -> bool:
    """Return whether noise is true for the current pipeline state."""
...
# Finds the words most likely to name the reported control.
    ...
    try:
        with sync_playwright() as pw:
            ...
            try:
                ...
                page = ctx.new_page()
                # Record the browser pageerror event as runtime evidence so the Analyzer can explain what failed.
                def _pageerror(e):
                    """Prepare the pageerror value or state used by this focused pipeline step."""
                ...
                # Record the browser console event as runtime evidence so the Analyzer can explain what failed.
                def _console(m):
                    """Prepare the console value or state used by this focused pipeline step."""
                ...
                # Record the browser response event as runtime evidence so the Analyzer can explain what failed.
                def _response(r):
                    """Prepare the response value or state used by this focused pipeline step."""
