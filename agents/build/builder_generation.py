...
from agents.build.builder_templates import BuilderTemplateMixin
from agents.build.builder_sanitize import BuilderSanitizeMixin


class BuilderAgent(BuilderGenerationMixin, BuilderTemplateMixin, BuilderSanitizeMixin):
    """Concrete builder composed from focused generation/template/sanitize stages."""
    pass
