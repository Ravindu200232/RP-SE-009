...
# Returns the installed documentation folder when it exists.
...
# Builds the short topic list shown to the agent.
...
# Returns the documentation requested in an agent reply.
