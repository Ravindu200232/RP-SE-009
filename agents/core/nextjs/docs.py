...
# Returns the local cache folder used for downloaded Next.js documentation.
def cache_dir() -> Path:
    """Return the local cache folder used for downloaded Next.js documentation."""
    return Path.home() / ".agentforge" / "docs" / "messages"


# Finds the error-help page names in build output.
...
# Builds guidance from the error-help pages named in the text.
