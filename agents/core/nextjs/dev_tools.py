...
# Builds one framed message for the Next.js development-tool connection.
def _frame(fr: dict) -> str:
    """Build one framed message for the Next.js development-tool connection."""
...
# Format the app's current errors while a browser session is open.
