...
# Checks whether a slash at this position can begin a JavaScript regular expression.
def _regex_can_start(src: str, i: int) -> bool:
    """Return whether a slash at this position can begin a JavaScript regular expression."""
    j = i - 1
...
def strip_noncode(src: str) -> str:
    ...
    # Replace one parsed source region with spaces while preserving line positions.
...
# Finds the end of a single-line pattern, or return zero.
