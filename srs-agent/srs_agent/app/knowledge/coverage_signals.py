...
Keyword signals only — deliberately deterministic. The CoverageAuditor uses
these so an idea that already says "guests pay online" is not marked as missing
`payments_billing` just because no question happened to ask about it.
"""
