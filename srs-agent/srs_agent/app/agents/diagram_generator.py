...
Pipeline:
  1. Build deterministic standards and architecture diagram models.
  2. Optionally enrich only the *editable Mermaid source* for supplemental views.
     The customer-visible layout is never delegated to the LLM.
  3. Render every diagram to the canonical native SVG layout; Mermaid is fallback/source.
"""
