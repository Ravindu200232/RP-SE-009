...
_SYS = (
    ...
    "SYSTEM CONTEXT: begin with one system boundary, keep people/integrations outside, "
    "and label every externally visible relationship. COMPONENT: group presentation, "
    "application/domain, and data/external components; give each component one clear "
    "responsibility; connect every displayed component through a supported dependency. "
    "DEPLOYMENT: begin with runtime nodes, place hosted artifacts inside their node, and "
    "label communication paths/protocols supported by the approved stack."
)
