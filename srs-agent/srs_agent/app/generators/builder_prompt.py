...
def render_prompt(handoff: dict, plan: dict, *, auth: bool = False,
    ...
    This is intentionally a specification handoff, not an implementation
    prompt that tells the builder how many components to write.  AgentForge's
    architect still owns decomposition; this text gives it the source facts it
    must not lose while planning.
    """
    plan = plan or {}
    doc = srs_document or {}
