...
The document is structured as an ISO/IEC/IEEE 29148:2018-aligned software
requirements specification with document control, identified requirements,
verification metadata, traceability, data/interface requirements and a
standards-oriented diagram appendix. ReportLab is pure Python and works on
Windows without native libraries.
"""
