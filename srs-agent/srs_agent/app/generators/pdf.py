...
def _plan_section(story: list, st: dict, W: float, h1, h2, plan: dict) -> None:
    ...
    It goes early and in their own words, because the rest of the document is a
    formal reading of exactly this and the reader should be able to check the
