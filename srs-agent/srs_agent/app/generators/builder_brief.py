"""Public builder-handoff API.

Implementation lives in small focused modules so the handoff can evolve without
turning this entry point into another large agent file.
"""
