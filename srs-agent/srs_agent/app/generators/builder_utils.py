...
def _strip_forbidden(text: str) -> str:
    ...
    The previous implementation dropped an entire sentence when it contained a
    package name.  A requirement such as "take card payments with Stripe" then
    vanished before the builder ever saw it.  Stack policy belongs to the
    builder; the SRS handoff must remain faithful to the approved product.
    """
