...
def _use_case(doc: dict, W: float) -> Drawing:
    ...
    # System boundary: quiet, white, with a strong but not loud label.
    ...
    all_case_y = [v[1] for v in case_pos.values()]
...
def _erd_layout(tables: list[dict], rels: list[dict], W: float):
    """Relation-aware layered layout. Parents sit left/top, dependants right/below."""
