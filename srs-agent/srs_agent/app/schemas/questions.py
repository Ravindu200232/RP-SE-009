...
class InterviewAnswer(BaseModel):
    ...
    `selected` and `custom` are kept apart from the merged `value` because
    "which of these, plus this thing I typed" is a distinction the merged list
    destroys — and the typed half is the part that gets read back for
    confirmation.
    """
