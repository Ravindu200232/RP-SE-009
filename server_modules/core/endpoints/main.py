...
# Purpose: Run start HTTP for this stage.
def start_http():
    try:
...
# Purpose: Handle main for this focused step.
async def main():
    global MAIN_LOOP
...
# Purpose: Handle shutdown all for this focused step.
def shutdown_all():
...
# Purpose: Handle handle signal for this focused step.
