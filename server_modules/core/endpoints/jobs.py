...
_JOB_PATHS = ("/image", "/logo-prompt", "/tune")


# Purpose: Handle jobs reap for this focused step.
def _jobs_reap():
    now = time.time()
...
# Purpose: Handle job run for this focused step.
...
# Purpose: Handle job poll for this focused step.
