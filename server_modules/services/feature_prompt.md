...
Analyze complete impact. A visual edit may own one file or many; follow source
evidence rather than forcing it into the selected file.
<!-- /CHANGE_REQUEST -->
...
and public contracts. If workspace inspection proves another safe source file
is essential, write it as part of this change. For edits, emit the complete
...
of a running Next.js page. Use the complete current source and workspace tools
...
- Reference it as `/generated/<semantic-name>.png` with concrete alt text that
  can serve as the generation subject prompt.
